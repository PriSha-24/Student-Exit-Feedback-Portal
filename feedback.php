...
<html>
  ...
  <form action="php/logout.php" method="POST">
    ...
    <h1 class="main-heading">Student Exit Feedback Form</h1>
    ...
    <div class="container">
      ...
      <form action="php/feed.php" method="post" class="student-form">
        <div class="student-details">
          <label for="year">Passout Year</label>
          <select name="year" id="year" style="width:200px;margin-left: 5.9%;">
          ...
          <input type="date" id="date" name="date" style="width:200px;margin-left: 3.4%;" />
          <br />

          <label for="branch">Branch</label>
          <select name="branch" id="branch" style="width:200px;margin-left: 9%;">
          ...
          <select name="faculty" id="faculty" style="width:200px;margin-left: 9%;">
            <option value="SVB">Souvik Basu</option>
            <option value="AK">Anirban Kundu</option>
            <option value="DK">Debabrata Kar</option>
            <option value="SNG">Sandipan Ganguly</option>
            <option value="SG">Suman Ghosh</option>
            <option value="PG">Palash Ghosh</option>
            <option value="SG">Souvik Ghosh</option>
            <option value="MC">Madhumita Chanda</option>
          </select>
          <br />
        </div>
    ...
    <div class="copyright-text">
      <p>© Copyright Priya Sharma 2023</p>
    </div>
  </body>
</html>
